package br.com.watch.watchserie.principal;

import br.com.watch.watchserie.model.DadosEpisodio;
import br.com.watch.watchserie.model.DadosSerie;
import br.com.watch.watchserie.model.DadosTemporada;
import br.com.watch.watchserie.model.Episodio;
...
public class Principal {
    ...
    private final String API_KEY = "&apikey=707568b0";
    ...
    public void exibMenu(){
      ...
      for(int i = 0; i < dados.totalTemporadas(); i++){
        ...
        Map<Integer, Double> avaliacoesPorTemporadas = episodio.stream()
